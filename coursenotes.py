...
def missing_fields(content, name, email):
  if content or name or email == "":
    return "Not so fast; you forgot to enter something!"

def invalid_email(email):
  if "@" and "." not in email:
    return "Your email doesn't look completely correct."
...
class MainHandler(Handler):
  ...
  def post(self):
    ...
    # if missing_fields(comment, name, email):
